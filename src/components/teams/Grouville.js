        ...
        <div id="club" className="uk-card uk-card-default clubcontainer">
          ...
          <div>
            <div className="uk-card-body">
              <h3 className="uk-card-title">Grouville</h3>
              <h6 className="clubinfo"><a href="www.westernmrc.org.je"></a></h6>
              <h6 className="clubinfo"><a href="mailto:westernmrc@gmail.com"></a></h6>
              <h6 className="clubinfo"><a href="https://goo.gl/maps/avfNWuVuE35VYBbH6"></a></h6>
              <h6 className="clubinfo"><a href="tel:www.westernmrc.org.je"></a></h6>
              <br></br>
              <h6 className="clubinfo"><strong>Operating Times:</strong> </h6>
              <h6 className="clubinfo"><strong>Club & Practice Night(s):</strong> </h6>
              <h6 className="clubinfo"><strong>Team Shooting Night:</strong> </h6>
              <br></br>
